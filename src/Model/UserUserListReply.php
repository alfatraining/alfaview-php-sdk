...
/**
 * UserUserListReply Class Doc Comment
 *
 * @category Class
 * @package  Alfaview
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserUserListReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'userUserListReply';
    ...
    protected static $swaggerTypes = [
        ...
        'users' => 'map[string,\Alfaview\Model\CommonUser]',
        'user_id_list' => 'string[]'
    ];
     ...
     * Gets users
     *
     * @return map[string,\Alfaview\Model\CommonUser]
     */
     ...
     * Sets users
     *
     * @param map[string,\Alfaview\Model\CommonUser] $users users
     *
     * @return $this
     */
