...
/**
 * BusinessLogicServiceInviteExternalMembersReply Class Doc Comment
 *
 * @category Class
 * @description * InviteExternalMembersReply contains the common reply information of the response to the InviteExternalMembersRequest. Deprecated: use guest service v2 instead.
 * @package  Alfaview
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessLogicServiceInviteExternalMembersReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'businessLogicServiceInviteExternalMembersReply';
