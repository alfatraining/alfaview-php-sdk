...
/**
 * Generated from protobuf message <code>roomService.RoomStatusReply</code>
 */
class RoomStatusReply extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *&#47; key is room-uuid
     *
     * Generated from protobuf field <code>map<string, .roomService.RoomInfo> rooms = 14;</code>
     */
    private $rooms;
    ...
    {
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \Alfatraining\Grpc\Room\RoomInfo::class);
        $this->rooms = $arr;
