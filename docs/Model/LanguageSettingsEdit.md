...
**transcription_enabled** | **bool** | If true, the transcription feature is enabled in this room. | [optional]
**transcription_type** | **string** | The type of transcription as selectable for room administrators in the client. | [optional]
